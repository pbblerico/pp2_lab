...
def show_the_score():
    screen.fill((0, 0, 0))
    text = font1.render('SEE YOU', True, (255, 0, 255))
    text3 = font2.render(f'{nick}', True, (255, 0, 255))
    rect = text3.get_rect(center = (200, 200))
    text1 = font1.render(f'Level: {level.level_count}', True, (255, 0, 255))
    text2 = font1.render(f'Score: {cnt}', True, (255, 0, 255))
...
def pause():
    screen.fill((0, 0, 0))
    text = font1.render('PAUSE...', True, (255, 0, 255))
    text1 = font1.render(f'Level: {level.level_count}', True, (255, 0, 255))
    text2 = font1.render(f'Score: {cnt}', True, (255, 0, 255))
...
font2 = pg.font.SysFont('Verdana', 20)
...
fpc = [7, 7.5, 8, 8.5] #changes the speed at each level
while run:
